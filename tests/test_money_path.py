...
(a phone-dashboard module) and an aion_core.reports.status() that surfaced
money_path.owner_line() inline. Neither exists on this tree and neither is
in this task's ALLOWED scope (aion_core/money_path.py,
tests/test_money_path.py, aion_core/cli.py only). Everything that exercises
money_path.py itself is kept.
"""
import json
import os
import unittest
...
from aion_core import bootstrap, metrics, money_path
