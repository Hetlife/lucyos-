...
DEFAULT_SKILLS = [
    ...
    dict(skill_id="core.taskcheck", name="LUCY TaskCheck", capabilities="taskcheck_create,taskcheck_assign,taskcheck_status,taskcheck_report,taskcheck_review,taskcheck_templates",
         executor_classes="DET", platforms="any", network_required=0, ai_required=0,
         offline_supported=1, cost_class="F0", risk_class="R1", data_class="INTERNAL", priority="P1",
         health_command="python3 -m unittest tests.test_taskcheck -v", test_command="python3 -m unittest tests.test_taskcheck -v"),
